...
//         mstore(allocate__7, add(mload(allocate__7), _C))
//         let allocate_p_1_2 := mload(allocate__7)
//         mstore(allocate__7, add(allocate_p_1_2, allocate__7))
//         mstore(add(allocate_p_1_2, 96), 2)
//     }
// }
